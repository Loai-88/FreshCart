...
export default function ResetPassword() {
    ...
    let resetPasswordValidation = Yup.object().shape({
        email:Yup.string().required('Email Is Required').email("In Valid Email"),
        newPassword:Yup.string().required("New Password Is Required").matches(/^[A-Z]\w{4,20}$/, 'Invalid Password EX (Ahmed123)'),
    })
            ...
            <div className='lg:flex'>
                ...
                <div className='lg:w-1/2 w-full  flex justify-center items-center'>
                    <div className='w-[90%] space-y-9 '>
                        <h1 className='text-center italic font-serif font-semibold text-3xl md:text-4xl'>Reset Your Password <i className="fa-solid fa-key"/></h1>
                        {
                        ...
                        <form onSubmit={formik.handleSubmit} className="mx-auto italic font-serif">
                            ...
                            <div className="mb-5">
                                <label htmlFor="newPassword" className="block mb-2 text-sm font-medium text-gray-900 dark:text-dark">Your New Password</label>
                                <input value={formik.values.newPassword} onChange={formik.handleChange} onBlur={formik.handleBlur} type="password" name='newPassword' id="newPassword" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='Your New Password' required />
                            </div>
                            {
