...
export default function Brands() {
    ...
    async function getAllSubBrand(brandId) {
        ...
        <>
            {Loading ? <div className='flex justify-center items-center '> {/* Full height and centered */}
                ...
                <div className='flex flex-wrap py-8 items-center justify-center '>
                    {Brands.map((brand) =>
                        <div key={brand._id} onClick={() => { getAllSubBrand(brand._id); setLoading(true) }} className='w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 2xl:w-1/5'>
