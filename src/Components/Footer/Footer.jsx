...
export default function Footer() {
    return (
        <>
            ...
            <div className='bg-main mt-24'>
                <footer className="bg-blue-100/80 font-sans dark:bg-gray-900">
                    <div className="container px-6 pt-[3rem] mx-auto">
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                            <div className="sm:col-span-2">
                                <h1 className="max-w-lg  w-fit tracking-tight text-gray-800  dark:text-white">
                                    <NavLink to={'home'}>
                                        <p className='text-2xl font-bold w-fit'><i className="fa-solid text-main fa-cart-shopping" />FreshCart</p>
                                    </NavLink></h1>
                        ...
                        <div className="sm:flex sm:items-center sm:justify-between">
                            <div className="flex flex-1 gap-4">
                                <img src="https://www.svgrepo.com/show/303139/google-play-badge-logo.svg" className='hover:cursor-pointer' width="130" height="110" alt="google-play-logo" />
                                <img src="https://www.svgrepo.com/show/303128/download-on-the-app-store-apple-logo.svg" className='hover:cursor-pointer' width="130" height="110" alt="app-store-apple-logo" />
                            </div>

                            <div className="flex gap-4">
                                <img src="https://www.svgrepo.com/show/303114/facebook-3-logo.svg" className='hover:cursor-pointer'  width="30" height="30" alt="fb" />
                                <img src="https://www.svgrepo.com/show/303115/twitter-3-logo.svg" className='hover:cursor-pointer' width="30" height="30" alt="tw" />
                                <img src="https://www.svgrepo.com/show/303145/instagram-2-1-logo.svg" className='hover:cursor-pointer' width="30" height="30" alt="inst" />
                                <img src="https://www.svgrepo.com/show/94698/github.svg" className='hover:cursor-pointer' width="30" height="30" alt="gt" />
                                <img src="https://www.svgrepo.com/show/22037/path.svg" className='hover:cursor-pointer' width="30" height="30" alt="pn" />
                                <img src="https://www.svgrepo.com/show/28145/linkedin.svg" className='hover:cursor-pointer' width="30" height="30" alt="in" />
                                <img src="https://www.svgrepo.com/show/22048/dribbble.svg" className='hover:cursor-pointer' width="30" height="30" alt="db" />
                            </div>
                        </div>
                        <p className="font-sans py-5 text-start md:text-center md:text-lg ">© 2025 You Company Inc. All rights reserved.</p>
                    </div>
                </footer>
            </div>
